...
<!-- <v-icon large  color="white" style="padding:10px;" @click="logout()">mdi-logout </v-icon> -->
  ...
  <!-- <v-app-bar app>
      ...
      <v-img class="mx-2" max-height="40" max-width="40" contain></v-img>
        <router-link to="/ManagerDashboards" style="text-decoration: none; color: inherit;margin-left:0px; margin-top:10px;">
...
<v-toolbar-title style="color:#ffffff;">Payroll</v-toolbar-title>
      ...
      <v-tabs-items v-model="tab">
        <v-tab-item>
          ...
          <v-card flat width="100%" style="padding:10px; margin-bottom:20px;">
            <v-card-text>


    <v-card  width="100%" style="padding:10px; margin-bottom:20px;">
    ...
    >
      ...
      sm="2"
      md="2">
       <v-btn @click="createPDF()" class="button" style="margin-left: 10px;">
      Download
    </v-btn>
          </v-col>
    ...
    <!-- <button @click="createPDF()" class="button" style="margin-left: 70px">
      Download
        ...
        <v-tab-item>
          <v-card flat>
            <v-card-text>
              <ManagerDownloadPayslip></ManagerDownloadPayslip>
            </v-card-text>
          </v-card>
        </v-tab-item>
      </v-tabs-items>
...
import ManagerDownloadPayslip from "./ManagerDownloadPayslip";
