...
<!-- <v-icon large  color="white" style="padding:10px;" @click="logout()">mdi-logout </v-icon> -->
     ...
     <!-- <v-app-bar app>
      ...
      <v-img class="mx-2" max-height="40" max-width="40" contain></v-img>
        <router-link to="/ManagerDashboard" style="text-decoration: none; color: inherit;margin-left:0px;margin-top:10px;">
...
<div >
      <Tabs >
        <Tab name="Attendence" selected="true">
          <div>
           <ManagerAttendanceview></ManagerAttendanceview>
          </div>
        </Tab>
