<template>
  <div id="managerleaveprofile">
     <!-- <v-app-bar app>
      <router-link to="/ManagerDashboard" style="text-decoration: none; color: inherit;">
      <v-row>
        <v-btn icon>
          <v-icon style="color:red;margin-left:20px; margin-top:50px;" size="30">mdi-home</v-icon>
        </v-btn>
      </v-row>
    
      </router-link>
      <v-img class="mx-2" max-height="40" max-width="40" contain></v-img>
        <router-link to="/ManagerDashboard" style="text-decoration: none; color: inherit;margin-left:0px; margin-top:60px;">
    ...
    >
 <router-link to="/ManagerDashboard" style="text-decoration: none; color: inherit;margin-bottom:55px;">
      <v-row>        
          <v-icon style="color:white;margin-left:20px;margin-top:20px;" large >mdi-home</v-icon>
      </v-row>
      </router-link>

<v-toolbar-title class="white--text" style="margin-bottom:2px; margin-left:50px;" ><img src="../assets/dis_logo_2022a.png" alt="dizitiveit.com" width="350px"></v-toolbar-title>
...
<div >
      <Tabs >
         <!-- <Tab name="Leave Dashboard" selected="true" >
          <div>
           <ManagerLeaveDashboard></ManagerLeaveDashboard>
          </div>
        </Tab> -->
          <Tab name="Leave Audit" selected="true">
          <div>
        ...
        <Tab name="Leave" >
          <div>
           <ManagerLeaveapply></ManagerLeaveapply>
          </div>
        </Tab>
      </Tabs>
    </div>
...
import ManagerLeaveapply from "./ManagerLeaveapply";
