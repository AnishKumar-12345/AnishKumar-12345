      ...
      md="3">
       <v-select
            ...
            >
              ...
              <option v-for="item in this.employeelist" :key="item.employeeId">
                {{ item.text }}
              </option>
            </select> -->
          </v-col>
          ...
          <tr>
            ...
            <td colspan="3" style="text-align:left;padding:3px"><b>Leave&nbsp;Balance</b></td>
             ...
             <td colspan="1" style="padding:0px" >
              <table style="border-color:white;border-style:none"
             >
                      <tr>
                        <td style="border-right:1px solid;padding: 0 7px;margin:0px">SL</td> <td style="border-right:1px solid;padding: 0 7px;margin:0px">{{this.result.sickLeaves}}</td>
                         <td style="border-right:1px solid;padding: 0 7px;margin:0px">CL</td> <td style="border-right:1px solid;padding: 0 7px;margin:0px">{{this.result.casualLeaves}}</td>
                          <td style="border-right:1px solid;padding: 0 7px;margin:0px" v-if="this.result.lop!=0">LOP</td> <td  v-if="this.result.lop!=0" style="padding:3px">{{this.result.lop}}</td>
                      </tr>
       ...
       <div style="height: 5px"></div>
        ...
        >
          <tr  style="background:#01009f">
            ...
            <td colspan="1.5" style="text-align:left;color:white;padding:3px;width:25%"><b>Current </b><span style="font-size:10px">(INR)</span></td>
            <td colspan="4.5" style="text-align:left;color:white;padding:3px;width:25%"><b>Deductions</b></td>
            <td colspan="1.5" style="text-align:left;color:white;padding:3px;width:25%"><b>Amount</b><span style="font-size:10px">(INR)</span></td>
          </tr>
        ...
        ">
          ...
          <div style="width: 100px;
              ...
              align-items: center;
              justify-content: end;
              border: 1px solid;padding:0px" ><b style="color:black">{{(this.result.netPay)}}</b></div>
        </div>
 ...
 mixins: [servicescall],
  data() {
    ...
    return {
      data: {},
      jwt: "",
    //  date: `${date.getDate()}-${montArr[monNumber]}-${date.getFullYear()}-${date.getSeconds()}`,
      generatedTime: format,
      menu: false,
      modal: false,
      selected:"",
      employeeId:"",
  ...
  mounted() {
    this.getList();
    //  this.getblukapi();
    //  console.log("Hello satya ",this.date.substring(0,4),this.date.substring(5,7));
  ...
  methods: {
    ...
    createPDF() {
      ...
      var style = "<style>";
      style = style + "table {width: 100%;font-size: 14px Calibri;}";
      style =
        style +
        ", th, td {border: solid 1px #292a2b; border-collapse: collapse;";
    ...
    getblukapi(selected) {
      ...
      this.getPaySlip(employeeId,month, year).then((response) => {
