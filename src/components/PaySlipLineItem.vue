...
<v-col cols="12" md="3">
            <v-select
              class="pr-1"
             :items="itemDetails1"
              label="Select Item Details"
              v-model="user.itemDetails"
              dense
              outlined
            ></v-select>
   </v-col>
<v-col cols="12" md="3">
            <v-select
              class="pr-1"
             :items=" this.itemType1"
              label="Select Item Type"
              v-model="user.itemType"
              dense
              outlined
            ></v-select>
  </v-col>
...
export default {
  ...
  methods: {
    ...
    PostLineItem() {
      ...
      console.log("check", this.selected,  this.month, this.year);
      this.PayslipLineItem(
        this.selected,
