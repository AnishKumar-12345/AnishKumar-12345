...
<v-icon large  color="white" style="padding:10px;" @click="logout()">mdi-logout </v-icon>
    ...
    >
     <v-app-bar-nav-icon
      ...
      <v-btn type="submit"   @click="PostIntime()" style="background:red;color:white">
       Web Clock In
      </v-btn>
       </v-col>
    ...
    msg: "Welcome to Your Vue.js App",
      ...
      items: [
...

        {
          ...
          items: [{ title: "Attendence", to: "/UserAttendenceprofile" }],
          title: "Attendence",
        },
        {
          action: "mdi-ticket",
          items: [
            { title: "Leave", to: "/UserLeaveprofile" },
        ...
        },
        {
          ...
          items: [
            { title: "payRoll", to: "/Userpayslipprofile" },
    ...
    PostOuttime() {
     ...
     this.userid =localStorage.getItem('id')
      ...
      this.getTodayAttendance(this.userid).then((response) => {
        this.result=response.data.EmployeeAttendance
       this.messageText=response.data.message
        console.log("In post", this.messageText = this.messageText,this.result);
      });
    },
     logout() {
