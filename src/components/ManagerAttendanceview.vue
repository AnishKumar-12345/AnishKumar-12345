        ...
        >
          ...
          >
            OK
                ...
                <v-col cols="12" md="1">
                  <v-btn type="submit" style="background:red;color:white" @click="getblukapi()"> Retrive
    ...
    >
      ...
      >
        ...
        >
          ...
          <v-col>
            <v-btn  style="background: red;color:white" @click="getEmployeeAttendance()">Retrieve</v-btn>
          </v-col>
        </v-row>
        	<v-data-table
    :headers="headers1"
...
export default {
  ...
  data() {
    return {
      ...
      items: [ "Attendance View","Employee Attedance view","","","","","","","","","",],
  ...
  methods: {
    ...
    getEmployeeAttendance() {
         var monthdata = this.date.substring(5,7);
         var yeardata = this.date.substring(0,4);
         var employeeId = this.selected;
      console.log("date", monthdata, yeardata, employeeId);
      this.getAttendenceView(employeeId, monthdata,yeardata).then((response) => {
        this.result1 = response.data.Attendance;

        console.log("In post", this.result1);
      });
    },
    ...
    //     this.employeeListData = response.data.EmployeeList;

    //     console.log("GetSupervisor List", this.employeeListData);
    //   });
    // },
     getListEmployeedata() {
      this.getEmployeeList(this.userid).then((response) => {
