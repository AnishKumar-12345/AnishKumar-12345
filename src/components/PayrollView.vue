                ...
                <v-row class="pl-0 pr-0">
                  <v-col cols="12" md="3" >
                    <v-text-field
                      ...
                      :rules="allowanceNameRule"
                      v-model="allowancesModel.allowanceName"
                      outlined
                      dense
                    ></v-text-field>
</v-col>
<v-col cols="12" md="3">
                    <v-select
                      ...
                      v-model="allowancesModel.allowanceType"
                      dense
                      outlined
                    ></v-select>
</v-col>
                ...
                <v-row class="pl-0 pr-0">
                  <v-col cols="12" md="3">
                    <v-text-field
                      ...
                      v-model="deductionModel.deductionName"
                      :rules="deductionNameRule"
                      outlined
                      dense
                    ></v-text-field>
</v-col>
<v-col cols="12" md="3">
                    <v-select
                      :items="this.deductionItem"
                      label="Deduction Type"
                      v-model="deductionModel.deductionType"
                      dense
                      outlined
                    ></v-select>
</v-col>
<v-col cols="12 text-left" md="3">
         ...
         <v-tab-item>
          <v-card flat>
            <v-card-text>
              <EmployeeAllowanceView></EmployeeAllowanceView>
            </v-card-text>
          </v-card>
        </v-tab-item>
         <v-tab-item>
          <v-card flat>
            <v-card-text>
              <EmployeeDeductionView></EmployeeDeductionView>
            </v-card-text>
          </v-card>
        </v-tab-item>
         <v-tab-item>
...
import MonthlySalarySave from "./MonthlySalarySave";
import EmployeeAllowance from "./EmployeeAllowance";
import EmployeeDeduction from "./EmployeeDeduction";
import EmployeeAllowanceView from "./EmployeeAllowanceView";
import EmployeeDeductionView from "./EmployeeDeductionView";
...
export default {
  ...
  mixins: [servicescall],
  components: {
   EmployeeAllowance,EmployeeDeduction,EmployeeAllowanceView,EmployeeDeductionView
  },
  data() {
    return {
      ...
      headers1: [
        ...
        { text: "ALLOWANCE VIEW", value: "allowanceName" },
